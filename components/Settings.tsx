      ...
      <div className="flex flex-col lg:flex-row gap-12 justify-center items-start max-w-5xl mx-auto">
        ...
        <div className="flex-1 space-y-8">
           ...
           <p className="text-gray-400 leading-relaxed text-sm">
             The client needed a way to scale their content production without hiring a team of writers. 
             This solution integrates standard business tools (Google Sheets) with advanced AI (OpenAI/n8n) 
             to create a "set and forget" publishing engine.
           </p>
           <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                 <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-1">Architecture</p>
                 <p className="text-xl font-bold text-white">AI-Native</p>
              </div>
              <div className="bg-white/5 p-4 rounded-xl border border-white/5">
        ...
        <div className="flex-1 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { name: 'OpenAI', desc: 'Content Generation', icon: 'fa-brain', color: 'text-orange-400' },
              { name: 'Apify', desc: 'Auto-Publishing', icon: 'fa-robot', color: 'text-purple-400' },
            ].map((tech) => (
